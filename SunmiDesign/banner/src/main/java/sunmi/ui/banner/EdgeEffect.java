...
public class EdgeEffect {
    ...
    //在释放前，被拉的辉光衰减到部分强度的时间
    // Time it will take in ms for a pulled glow to decay to partial strength before release
    private static final int PULL_DECAY_TIME = 2000;

    private static final float MAX_ALPHA = 0.5f;//光影透明度

    private static final float MAX_GLOW_SCALE = 2.f;//光影最大scale

    private static final float PULL_GLOW_BEGIN = 0.f;//从哪里开始发光（相对于view）
    ...
    private static final int STATE_RECEDE = 3; //褪去状态
    private static final int STATE_PULL_DECAY = 4; //衰变状态

    private static final float PULL_DISTANCE_ALPHA_GLOW_FACTOR = 0.8f; //距离因子

    private static final int VELOCITY_GLOW_FACTOR = 6; //速度因子
    ...
    private float mDisplacement = 0.5f; //排水量
...
//        mPaint.setColor((themeColor & 0xffffff) | 0x33000000);
    ...
    public void setSize(int width, int height) {
        final float r = width * 0.75f / SIN; //算出2R 直径
        final float y = COS * r;//三角函数 算出直角三角形临边
        final float h = r - y;
